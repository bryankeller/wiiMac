...
OBJS = bin/realmode.o bin/crt0.o bin/main.o bin/string.o bin/sync.o bin/time.o bin/printf.o bin/input.o \
	...
	bin/irq.o bin/sha1.o bin/macho_loader.o bin/boot_args.o bin/device_tree.o bin/hfs/cache.o bin/hfs/disk.o \
	bin/hfs/hfs.o bin/hfs/hfs_compare.o bin/hfs/sys.o bin/hfs/md5c.o
