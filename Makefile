...
OBJS = bin/realmode.o bin/crt0.o bin/main.o bin/string.o bin/sync.o bin/time.o bin/printf.o bin/input.o \
	...
	bin/irq.o bin/sha1.o bin/macho.o bin/boot_args.o bin/device_tree.o bin/apm.o bin/hfsplus/hfsp_blockiter.o \
	bin/hfsplus/hfsp_btree.o bin/hfsplus/hfsp_fs.o bin/hfsplus/hfsp_record.o bin/hfsplus/hfsp_unicode.o \
	bin/hfsplus/hfsp_volume.o bin/hfsplus/libhfsp.o
